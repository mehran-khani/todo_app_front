...
// in to_do_application/test/tag_bloc/tag_bloc_test.dart.
...
import 'package:to_do_application/models/tag_model.dart/tag_model.dart' as _i3;
...
class MockBox extends _i1.Mock implements _i2.Box<_i3.TagModel> {
  @override
  Iterable<_i3.TagModel> get values => (super.noSuchMethod(
        Invocation.getter(#values),
        returnValue: <_i3.TagModel>[],
        returnValueForMissingStub: <_i3.TagModel>[],
      ) as Iterable<_i3.TagModel>);
  ...
  @override
  Iterable<_i3.TagModel> valuesBetween({
    dynamic startKey,
    dynamic endKey,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.TagModel? getAt(int? index) => (super.noSuchMethod(
        Invocation.method(
          #getAt,
          [index],
        ),
  ...
  @override
  Map<dynamic, _i3.TagModel> toMap() => (super.noSuchMethod(
        Invocation.method(
          #toMap,
          [],
        ),
        returnValue: <dynamic, _i3.TagModel>{},
        returnValueForMissingStub: <dynamic, _i3.TagModel>{},
      ) as Map<dynamic, _i3.TagModel>);
  ...
  @override
  _i5.Future<void> putAll(Map<dynamic, _i3.TagModel>? entries) =>
      (super.noSuchMethod(
        Invocation.method(
          #putAll,
          [entries],
  ...
  @override
  _i5.Future<int> add(_i3.TagModel? value) => (super.noSuchMethod(
        Invocation.method(
          #add,
          [value],
        ),
  ...
  @override
  _i5.Future<Iterable<int>> addAll(Iterable<_i3.TagModel>? values) =>
      (super.noSuchMethod(
        Invocation.method(
          #addAll,
          [values],
